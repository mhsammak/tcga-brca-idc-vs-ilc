...
```{r}
idc <- read.csv("./Results/dge-normal-vs-idc-all-sig.csv")
ilc <- read.csv("./Results/dge-normal-vs-ilc-all-sig.csv")
```
```{r}
...
```
```{r}
write.csv(ilcExcUp, "./Results/ilc-exclusive-up-all.csv")
write.csv(ilcExcDown, "./Results/ilc-exclusive-down-all.csv")
write.csv(idcExcUp, "./Results/idc-exclusive-up-all.csv")
write.csv(idcExcDown, "./Results/idc-exclusive-down-all.csv")
```
```{r}
...
```
```{r}
write.csv(comUp, "./Results/common-up-all.csv")
write.csv(comDown, "./Results/common-down-all.csv")
```
...
```{r}
idcAll <- read.csv("./Results/dge-normal-vs-idc-all-all.csv")
ilcAll <- read.csv("./Results/dge-normal-vs-ilc-all-all.csv")
```
```{r}
...
write.csv(keggComUp, "./Results/ora-kegg-common-up-all.csv")
```
```{r}
...
write.csv(keggComDown, "./Results/ora-kegg-common-down-all.csv")
```
```{r}
...
write.csv(keggIlcExcUp, "./Results/ora-kegg-ilc-exclusive-up-all.csv")
```
```{r}
...
write.csv(keggIlcExcDown, "./Results/ora-kegg-ilc-exclusive-down-all.csv")
```
```{r}
...
write.csv(keggIdcExcUp, "./Results/ora-kegg-idc-exclusive-up-all.csv")
```
```{r}
...
write.csv(keggIdcExcDown, "./Results/ora-kegg-idc-exclusive-down-all.csv")
```
...
dotplot(keggIdcExcUp, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-kegg-exclusive-up-idc-all.tiff", dpi = 300)
...
dotplot(keggIdcExcDown, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-kegg-exclusive-down-idc-all.tiff", dpi = 300)
```

################################################################################
############## GO BP Analysis of Common & Exclusive DEGs #######################
################################################################################
...
goComUp <- enrichGO(gene = comUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goComUp, "./Results/ora-go-common-up-bp-all.csv")
...
goComDown <- enrichGO(gene = comDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goComDown, "./Results/ora-go-common-down-bp-all.csv")
...
goIlcUp <- enrichGO(gene = ilcExcUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goIlcUp, "./Results/ora-go-ilc-exclusive-up-bp-all.csv")
...
goIlcDown <- enrichGO(gene = ilcExcDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goIlcDown, "./Results/ora-go-ilc-exclusive-down-bp-all.csv")
...
goIdcUp <- enrichGO(gene = idcExcUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goIdcUp, "./Results/ora-go-idc-exclusive-up-bp-all.csv")
...
goIdcDown <- enrichGO(gene = idcExcDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goIdcDown, "./Results/ora-go-idc-exclusive-down-bp-all.csv")
```
...
dotplot(goComUp, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-common-up-bp-all.tiff", dpi = 300)
...
dotplot(goComDown, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-common-down-bp-all.tiff", dpi = 300)
...
dotplot(goIdcUp, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-idc-exclusive-up-bp-all.tiff", dpi = 300)
...
dotplot(goIdcDown, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-idc-exclusive-down-bp-all.tiff", dpi = 300)
```
...
goComUp <- enrichGO(gene = comUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goComUp, "./Results/ora-go-common-up-mf-all.csv")
...
goComDown <- enrichGO(gene = comDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goComDown, "./Results/ora-go-common-down-mf-all.csv")
...
goIlcUp <- enrichGO(gene = ilcExcUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goIlcUp, "./Results/ora-go-ilc-exclusive-up-mf-all.csv")
...
goIlcDown <- enrichGO(gene = ilcExcDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goIlcDown, "./Results/ora-go-ilc-exclusive-down-mf-all.csv")
...
goIdcUp <- enrichGO(gene = idcExcUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goIdcUp, "./Results/ora-go-idc-exclusive-up-mf-all.csv")
...
goIdcDown <- enrichGO(gene = idcExcDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goIdcDown, "./Results/ora-go-idc-exclusive-down-mf-all.csv")
```
```{r}
goComUp@result$Description <- str_to_sentence(str_wrap(goComUp@result$Description, 25))
goComDown@result$Description <- str_to_sentence(str_wrap(goComDown@result$Description, 25))
...
dotplot(goComUp, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-common-up-mf-all.tiff", dpi = 300)

dotplot(goComDown, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ggtitle("Molecular Functions of Common Down-regulated Genes") +
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-common-down-mf-all.tiff", dpi = 300)

dotplot(goIdcUp, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ggtitle("Molecular Functions of Exclusive Up-regulated Genes in IDC") +
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-idc-exclusive-up-mf-all.tiff", dpi = 300)

dotplot(goIdcDown, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ggtitle("Molecular Functions of Exclusive Down-regulated Genes in IDC") +
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-idc-exclusive-down-mf-all.tiff", dpi = 300)
...
dotplot(goIlcUp, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-ilc-exclusive-up-mf-all.tiff", dpi = 300)
```
