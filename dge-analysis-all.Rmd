...
write.csv(keggComUp, "./Results/ora-common-up-all.csv")
```
```{r}
...
write.csv(keggComDown, "./Results/ora-common-down-all.csv")
```
```{r}
...
write.csv(keggIlcExcUp, "./Results/ora-ilc-exclusive-up-all.csv")
```
```{r}
...
write.csv(keggIlcExcDown, "./Results/ora-ilc-exclusive-down-all.csv")
```
```{r}
...
write.csv(keggIdcExcUp, "./Results/ora-idc-exclusive-up-all.csv")
```
```{r}
...
write.csv(keggIdcExcDown, "./Results/ora-idc-exclusive-down-all.csv")
```
...
goComUp <- enrichGO(gene = comUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goComUp, "./Results/go-common-up-bp-all.csv")
...
goComDown <- enrichGO(gene = comDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goComDown, "./Results/go-common-down-bp-all.csv")
...
goIlcUp <- enrichGO(gene = ilcExcUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goIlcUp, "./Results/go-ilc-exclusive-up-bp-all.csv")
...
goIlcDown <- enrichGO(gene = ilcExcDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goIlcDown, "./Results/go-ilc-exclusive-down-bp-all.csv")
...
goIdcUp <- enrichGO(gene = idcExcUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goIdcUp, "./Results/go-idc-exclusive-up-bp-all.csv")
...
goIdcDown <- enrichGO(gene = idcExcDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goIdcDown, "./Results/go-idc-exclusive-down-bp-all.csv")
```
...
dotplot(goComUp, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-bp-common-up-all.tiff", dpi = 300)
...
dotplot(goComDown, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-bp-common-down-all.tiff", dpi = 300)
...
dotplot(goIdcUp, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-bp-exclusive-up-idc-all.tiff", dpi = 300)
...
dotplot(goIdcDown, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-bp-exclusive-down-idc-all.tiff", dpi = 300)
```
...
goComUp <- enrichGO(gene = comUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goComUp, "./Results/go-common-up-mf-all.csv")
...
goComDown <- enrichGO(gene = comDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goComDown, "./Results/go-common-down-mf-all.csv")
...
goIlcUp <- enrichGO(gene = ilcExcUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goIlcUp, "./Results/go-ilc-exclusive-up-mf-all.csv")
...
goIlcDown <- enrichGO(gene = ilcExcDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goIlcDown, "./Results/go-ilc-exclusive-down-mf-all.csv")
...
goIdcUp <- enrichGO(gene = idcExcUp$ENTREZID,
                    ...
                    qvalueCutoff = 0.05,
                    readable = TRUE)
write.csv(goIdcUp, "./Results/go-idc-exclusive-up-mf-all.csv")
...
goIdcDown <- enrichGO(gene = idcExcDown$ENTREZID,
                      ...
                      qvalueCutoff = 0.05,
                      readable = TRUE)
write.csv(goIdcDown, "./Results/go-idc-exclusive-down-mf-all.csv")
```

################################################################################
################## Visualizing Molecular Functions #############################
################################################################################
...
dotplot(goComUp, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-common-up-all.tiff", dpi = 300)

dotplot(goComDown, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ggtitle("Molecular Functions of Common Down-regulated Genes") +
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-common-down-all.tiff", dpi = 300)

dotplot(goIdcUp, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ggtitle("Molecular Functions of Exclusive Up-regulated Genes in IDC") +
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-exclusive-up-idc-all.tiff", dpi = 300)

dotplot(goIdcDown, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ggtitle("Molecular Functions of Exclusive Down-regulated Genes in IDC") +
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-exclusive-down-idc-all.tiff", dpi = 300)
...
dotplot(goIlcUp, showCategory = 10) + xlab("Gene Ratio") + ylab("Description") +
  ...
  theme_cleveland() + guides(colour = guide_legend(title = "Adj p-value"),
                             size = guide_legend(title = "Gene Count"))
ggsave("./Figures/ora-go-exclusive-up-ilc-all.tiff", dpi = 300)
```
